    ...
    return (
        <div>
            <Stack direction="horizontal" >
                ...
                <Button variant="primary" size="lg" className="me-2"><Image src="/svg/heart.svg" alt="Love Icon" width={20} height={20} /><span className="m-0 ms-1">{info.loves} Hayransı</span></Button> 
