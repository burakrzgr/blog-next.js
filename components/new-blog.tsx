...
export default function NewBlog({editBlog}:{editBlog:CreateBlog}) {
    ...
    const [writer, setWriter] = useState<BlogWriter>({ userId: 'RxrvSA0ZawSjanoiUYPhUW6dCu93', username: "Anon", image: "test", color: "000000",blogs:[] });
            ...
            getDocs(q)
                .then((data) => {
                    data.docs.length > 0 ?
                        ...
                        setWriter({ userId: 'RxrvSA0ZawSjanoiUYPhUW6dCu93', username: "Anon", image: "test", color: "000000",blogs:[] });
                });
        }
    }, []);
    useEffect(() => {
